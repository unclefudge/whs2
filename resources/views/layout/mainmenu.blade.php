                                            ...
                                            <div class="col-md-2">
                                                <ul class="mega-menu-submenu">
                                                    ...
                                                    @if (Auth::user()->hasAnyPermissionType('site.hazard'))
                                                        <li><a href="/site/hazard" class="nav-link @if (Auth::user()->siteHazards('1')->count()) font-yellow-lemon @endif">Hazard Reports</a></li>
                                                    @endif

                                                    @if (Auth::user()->hasAnyPermissionType('site.accident'))
                                                        <li><a href="/site/accident" class="nav-link @if (Auth::user()->siteAccidents('1')->count()) font-yellow-lemon @endif">Accident Reports</a></li>
                                                    @endif
                            ...
                            <li>
                                <div class="mega-menu-content">
                                    <div class="row">
                                        ...
                                        @endif
                                        @if (Auth::user()->hasAnyPermissionType('company.doc'))
                                            <div class="col-md-2">
                                                <ul class="mega-menu-submenu">
                                                    <li><h3 class="h3-submenu">Documents</h3></li>
                                        ...
                                        @if(Auth::user()->hasAnyPermissionType('user|company|client'))
                                            <div class="col-md-2">
                                                <ul class="mega-menu-submenu">
                                                    ...
                                                    @else
                                                        <li><h3 class="h3-submenu">User</h3></li>
                                                    @endif
                                                    ...
                                                    @endif
                                                    @if (Auth::user()->company->subscription > 1 && (Auth::user()->hasPermission2('edit.company') || Auth::user()->isSupervisor()))
