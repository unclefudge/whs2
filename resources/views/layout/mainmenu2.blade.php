<li class="menu-dropdown mega-menu-dropdown ">
    <a href="javascript:;"><i class="fa fa-medkit"></i> Safety
...
<li class="menu-dropdown classic-menu-dropdown ">
    <a href="javascript:;"><i class="fa fa-wrench"></i> Work Site
        <span class="arrow"></span>
    </a>
...
<li class="menu-dropdown mega-menu-dropdown  mega-menu-full">
    <a href="javascript:;"><i class="fa fa-file-o"></i> Reports
        <span class="arrow"></span>
    </a>
...
<li class="menu-dropdown classic-menu-dropdown ">
    <a href="javascript:;"><i class="fa fa-crosshairs"></i> Expand
        <span class="arrow"></span>
    </a>
    <ul class="dropdown-menu pull-left">
            ...
            <ul class="dropdown-menu">
                <li class="dropdown-submenu ">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="">
                            <a href="table_static_responsive.html" class="nav-link "> Responsive
                                Tables </a>
                        </li>
                    </ul>
                </li>
