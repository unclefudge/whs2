...
@section('breadcrumbs')
    <ul class="page-breadcrumb breadcrumb">
        ...
        @if (Auth::user()->hasAnyPermissionType('site.export'))
            <li><a href="/planner/export">Export</a><i class="fa fa-circle"></i></li>
        @endif
                ...
                <div class="portlet light ">
                    ...
                    <div class="portlet-body form">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group {!! fieldHasError('email_list', $errors) !!}">
                                    ...
                                    {!! Form::text('email_list', 'scott@capecod.com.au; nadia@capecod.com.au; grahame@capecod.com.au; nicole@capecod.com.au; kirstie@capecod.com.au;chris@capecod.com.au; robert@capecod.com.au; kylie@capecod.com.au; alethea@capecod.com.au; james@capecod.com.au; demi@capecod.com.au; george@capecod.com.au', ['class' => 'form-control']) !!}
                        ...
                        <div class="form-actions right">
                            <a href="/planner/export" class="btn default"> Back</a>
                        </div>
                        {!! Form::close() !!}
                    </div>
                </div>
